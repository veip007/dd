...
case $N in
  ...
  12) bash InstallNET.sh -dd 'https://www.lefu.men/gdzl/index.php?id=1IXdK-ruDrNmorxZRoJaep1Fo9p4aPi0s' ;;
  13) bash InstallNET.sh -dd 'https://www.lefu.men/gdzl/index.php?id=1JnbvgbvF4hzT1msk1RJ-rjrzqqzTwI1I' ;;
  14) bash InstallNET.sh -dd 'https://www.lefu.men/gdzl/index.php?id=1vz2Y9kPlbRYdP8blD0oGs5MY7EfYVgFR' ;;
  15) bash InstallNET.sh -dd 'https://www.lefu.men/gdzl/index.php?id=1dvNvV9OLm-x6p9sUbnRrKTLDuaiVj_Kg' ;;
  16) bash InstallNET.sh -dd 'https://www.lefu.men/gdzl/index.php?id=1O3jXs9KagrCb1SbM-DVZMAZ7gw9r3Vtp' ;;
  17) bash InstallNET.sh -dd 'https://www.lefu.men/gdzl/index.php?id=1PLG3EdCziMMTIWz1vnUupMPmje2pQX43' ;;
  18) bash InstallNET.sh -dd 'https://www.lefu.men/gdzl/index.php?id=16Xh4iq6guHWT92MAr-NCOzStZqMTdnmU' ;;
  19) bash InstallNET.sh -dd 'https://drive.google.com/open?id=1rzkH24tCtwPvcT3HquoF9tZgcj022voG' ;;
  20) bash InstallNET.sh -dd 'https://www.lefu.men/gdzl/index.php?id=1wtUWaag5pVwmN-QUfTSJ6xbNWulLbLy-' ;;
  21) bash InstallNET.sh -dd 'https://www.lefu.men/gdzl/index.php?id=1GUdLXMwBx4uM8-iBU6ClcD5HRmkURuEl' ;;
  22) bash Network-Reinstall-System-Modify.sh --DD "https://www.lefu.men/gdzl/index.php?id=1gGUD4lNp6GapR_-78LlmleDRW55Ao0r9" ;;
  *) echo "Wrong input!" ;;
esac 
